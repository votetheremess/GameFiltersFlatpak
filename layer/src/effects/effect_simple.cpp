...
namespace vkBasalt
{
                            ...
                            VkFormat             viewFormat)
    {
        ...
        const VkFormat effectiveViewFormat = (viewFormat == VK_FORMAT_UNDEFINED) ? format : viewFormat;

        inputImageViews = createImageViews(pLogicalDevice, effectiveViewFormat, inputImages);
        Logger::debug("created input ImageViews");
        outputImageViews = createImageViews(pLogicalDevice, effectiveViewFormat, outputImages);
        ...
        renderPass = createRenderPass(pLogicalDevice, effectiveViewFormat);
